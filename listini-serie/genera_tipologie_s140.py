...
ACC_XX = squadr(0, 16, 16, 8) + [A('V50051', 'Compensazione cover-labirinto', 6), A('V51046', 'Coppia tappi laterali gocciolatoio', 1), A('V51052', 'Valvolina di drenaggio', 1), A('V53054', 'Kit tappi labirinto V31013', 1), A('V55168', 'Tappi chiusura tubolare U10020', 3),
...
PROF_XX = telaio('U10020') + [P('U10140', 'Traverso anta', 4, 'L/2-7', '45-45'), P('U10140', 'Montante anta', 4, 'H-86.5', '45-45'), P('N10909', 'Profilo scatto labirinto', 2, 'H-90.5'), P('N10901', 'Profilo di finitura laterale', 2, 'H-58'), P('N10902', 'Gocciolatoio', 1, 'L-55'), P('N10630', 'Binario', 2, 'L-104')] + fv(4, 'L/2-135', 4, 'H-250.5')
...
ACC_XXS = squadr(0, 8, 8, 8) + [A('V51046', 'Coppia tappi laterali gocciolatoio', 1), A('V51052', 'Valvolina di drenaggio', 1), A('V53055', 'Kit tappi labirinto slim V31015', 1), A('V55168', 'Tappi chiusura tubolare U10020', 3), A('V58031', 'Kit base 2 ante per alzante scorrevole', 1), A('V58037', 'Tappo tenuta centrale inferiore telaio', 1),
...
PROF_XXS = telaio('U10020') + [P('U10120', 'Montante centrale anta slim', 2, 'H-205.5'), P('U10140', 'Traverso anta', 4, 'L/2-29.5', '45-90'), P('U10140', 'Montante anta', 4, 'H-86.5', '45-45'), P('N10909', 'Profilo scatto labirinto', 2, 'H-90.5'), P('N10901', 'Profilo di finitura laterale', 2, 'H-58'), P('N10902', 'Gocciolatoio', 1, 'L-55'), P('N10630', 'Binario', 2, 'L-104')] + fv(4, 'L/2-112.5', 4, 'H-250.5')
...
PROF_4A = telaio('U10020') + [P('U10140', 'Traverso anta laterale (L1-7)', 4, 'L/4+13', '45-45'), P('U10140', 'Traverso anta centrale (L2+34.5)', 4, 'L/4+14.5', '45-45'), P('U10140', 'Montante anta', 8, 'H-86.5', '45-45'), P('U10601', 'Riporto ante in linea', 1, 'H-134.5'), P('N10909', 'Profilo scatto labirinto', 4, 'H-90.5'), P('N10901', 'Profilo di finitura laterale', 2, 'H-58'), P('N10902', 'Gocciolatoio', 1, 'L-55'), P('N10630', 'Binario', 2, 'L-104'),
...
ACC_4A = squadr(0, 32, 32, 8) + [A('V50051', 'Compensazione cover-labirinto', 12), A('V51046', 'Coppia tappi laterali gocciolatoio', 1), A('V51052', 'Valvolina di drenaggio', 1), A('V53054', 'Kit tappi labirinto V31013', 2), A('V55168', 'Tappi chiusura tubolare U10020', 4), A('V58031', 'Kit base 2 ante per alzante scorrevole', 2), A('V58037', 'Tappo tenuta centrale inferiore telaio', 2),
...
PROF_4AS = telaio('U10020') + [P('U10120', 'Montante centrale anta slim', 4, 'H-205.5'), P('U10140', 'Traverso anta laterale (L1-29.5)', 4, 'L/4-9.5', '45-90'), P('U10140', 'Traverso anta centrale (L2+12)', 4, 'L/4-8', '90-45'), P('U10140', 'Montante anta', 4, 'H-86.5', '45-45'), P('U10601', 'Riporto ante in linea', 1, 'H-134.5'), P('N10909', 'Profilo scatto labirinto', 4, 'H-90.5'), P('N10901', 'Profilo di finitura laterale', 2, 'H-58'), P('N10902', 'Gocciolatoio', 1, 'L-55'), P('N10630', 'Binario', 2, 'L-104'),
...
ACC_4AS = squadr(0, 16, 16, 8) + [A('V51046', 'Coppia tappi laterali gocciolatoio', 1), A('V51052', 'Valvolina di drenaggio', 1), A('V53055', 'Kit tappi labirinto slim V31015', 2), A('V55168', 'Tappi chiusura tubolare U10020', 4), A('V58031', 'Kit base 2 ante per alzante scorrevole', 2), A('V58037', 'Tappo tenuta centrale inferiore telaio', 2), A('V58042', 'Kit tappi ante in linea', 1),
...
def ribassata(t):
    ...
    fam = 'XX' if tel == 'U10020' else 'OX' if tel == 'U10000' else '3V'
    ...
    for p in r['profili']:
        a, d = p['art'], p['desc']
        if a in ('U10020', 'U10000', 'U10060', 'U10061') and d.startswith('Traverso'): p = dict(p, pz=1); prof.append(p); continue
        if a in ('U10020', 'U10000', 'U10060', 'U10061') and d.startswith('Montante'): p = dict(p, ang='90-45'); prof.append(p); continue
