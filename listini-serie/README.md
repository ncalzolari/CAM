...
- Tipologie in `tipologie_s140.json` dalle **distinte di taglio ufficiali** (soglia standard): alzante XX 2 ante mobili (8.02-8.03), alzante OX 1 anta + fisso su telaio (8.12-8.13), scorrevole in linea XX (8.52-8.53), scorrevole in linea 2 ante una fissa (8.56-8.57). Vetro 28: fermavetro N10823, guarnizione interna 809122, esterna V03000. Voci opzionali escluse; tasselli 712322 e maniglia (da inserire) aggiunti da noi.
- Altre distinte disponibili nel catalogo, non ancora trascritte: XX/4 ante con montante slim U10120 (8.04, 8.10, 8.54, 8.58), 3 ante (8.06), 4 ante (8.08), varianti OX (8.14-8.20), OXO (8.22), 4 ante con 2 fisse slim (8.26), soglia ribassata U10400/U10401 (seconda colonna di ogni distinta).
...
- Ore manodopera provvisorie: 8 h alzante XX, 6 h OX e in linea XX, 5 h in linea una fissa.
