...
<section id="sez-iwg"><h2>Invio a IWG-Preventivatore</h2><div class="corpo">
  <div class="param" style="grid-template-columns:14rem 14rem auto;align-items:end">
    ...
    <div><button class="primario" id="btn-iwg-invia">Invia listini a IWG-Preventivatore</button> <button id="btn-iwg-json">Scarica JSON per importazione manuale</button></div>
  </div>
