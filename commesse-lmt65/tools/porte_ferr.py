...
P['porte_ferr'] = {
  'nota': 'TUTTO DA TARARE: convenzioni facce/versi per analogia con C75S; quote dal manuale AluK v4.A. Modificare qui (o in dati_serie.js) senza toccare il codice. '
          ...
          'Audit geometrico 15/09/2026 (tools/audit_geom_lav.py, dossier sez. 12 addendum): ~40 delle 85 combinazioni profilo/faccia/Y generate per S140+D67+D77 '
          'cadono fuori dal tracciato DXF reale del profilo ("nel vuoto" nello schema-pezzo), quasi tutte qui in D67/D77 (fissaggio telaio, cerniere, serratura, '
          'catenaccio). NON corrette: uno snap geometrico al punto valido più vicino (fatto invece per S140, dove funziona) qui farebbe collassare operazioni '
          'diverse con quote diverse nel manuale sullo stesso punto (F4 tocca materiale solo in una fascia stretta vicino a un angolo per questi profili a "L") '
          '- serve il vero manuale lavorazioni D67/D77 (mai ricevuto: il solo PDF disponibile, Catalogo Tecnico D67-D77 v4C, non ha una sezione lavorazioni) per '
          'rifare questo modulo con lo stesso rigore usato per S140.',
  'AM': 1050,
