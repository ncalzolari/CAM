...
DIM = {'U10020': ('telaio', 140, 62.3), 'U10000': ('telaio', 140, 62.3), 'U10060': ('telaio', 120, 62.3), 'U10061': ('telaio', 116, 62.3),
...
SC = {'U10020': ('TELL', 'TELH'), 'U10000': ('TELL', 'TELH'), 'U10060': ('TELL', 'TELH'), 'U10061': ('TELI', 'TEHI'), 'U10400': ('SOGL', 'SOGL'), 'U10401': ('SOGL', 'SOGL'), 'U10402': ('SOGL', 'SOGL'), 'U10403': ('SOGE', 'SOGE'),
...
# data/dxf_sez_s140.json per uso futuro ma non sono agganciate a nessun profilo). Il codice del telaio 2 binari
# era stato trascritto "U10022" dal testo OCR del catalogo (compariva così in tutte le sezioni: profili, nodi,
# distinte, accessori); l'utente ha confermato il 15/09/2026 che il codice vero è "U10020" (coerente col DXF
# ricevuto, 140,0 mm di larghezza = la quota di catalogo) -> corretto ovunque nelle fonti (non solo qui).
dxf_sez = {}
mancanti = []
